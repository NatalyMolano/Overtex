...
<div class="form-container">
    <div class="product-heading">
        <i class="fas fa-list"></i> Editar Venta
    </div>
    <div class="d-flex">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="Documento" class="form-control" min="7" max="11" value ="${clienteEncontrado.getDocumento()}" size="11">
                                    <button  class="btn btn-outline-primary" type="submit" name="opcion" value="consultarCliente1" >
                                    ...
                                    %>
                                    <input type="hidden" name="idCliente" class="form-control" min="7" max="11" value ="<%=venVO.getIdidCliente()%>">
                                    <%
                                        }
                                    %>


                                    <input type="hidden" value="${sessionScope.IdVenta}" name="IdVenta">
                                    <%
                                    ...
                                    <input type="hidden" name="idUsuario" id="idUsuarioSesion" value="<%=Id%>" size="1">
                                     <button class="btn btn-outline-secondary" type="submit" name="opcion"  value="actualizarVenta" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    ...
                                    <button type="submit" name="opcion" value="consultarcodigoVenta1" class="btn btn-outline-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/></button>
                                    </svg>
                                    </button>
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" value="<%=ProdVO.getPrecioUnidad()%>" class="form-control" name="precioVenta" size="11" minlength="3" maxlength="9"  placeholder="0">
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" value="1" class="form-control" name="cantidadVenta" size="11" minlength="1" maxlength="3" required>
                                <p><small>En existencia hay <%=ProdVO.getProStock()%></small></p>

                                <button class="btn btn-outline-primary" type="submit" name="opcion" value="agregarDetalleVenta" >Agregar</button>
                        ...
                        <table class="table" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input style="background: transparent; border: none;" type="hidden" value="<%=deVO.getId_DetalleVenta()%>" name="IdDetalleVenta" size="0" readonly></td>
                                    ...
                                    <td>
                                        <button type="submit" name="opcion" value="borrarDetalleVenta1" class="btn btn-outline-danger">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a href="Actualizar_Venta.jsp"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Salir</button></a>
