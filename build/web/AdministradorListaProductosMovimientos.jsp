...
<div class="form-container">
    <div class="product-heading">
        <i class="fas fa-list"></i> Movimientos de la Compra
    </div>
        ...
        <table id="example" class="display nowrap" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th scope="col">Cantidad Antigua</th>
                    <th scope="col">Cantidad Alterada</th>
            ...
            <tbody>
                <% 
                    ...
                    ProductosModificacionesVO ProdVO = new ProductosModificacionesVO();
                    ProductoModificacionesDAO ProdDAO = new ProductoModificacionesDAO();

                    ArrayList<ProductosModificacionesVO> listarProducto = ProdDAO.listar();
                ...
                %>
                <tr>
                    <td><%= ProdVO.getId_modificacion_producto()%></td>
                    <td><%= ProdVO.getProNombre()%></td>
                    <td><%=ProdVO.getAntiguo_PrecioUnidad()%></td>
                    <td><%=ProdVO.getModificado_PrecioUnidad()%></td>
                     <td><%=ProdVO.getAntiguo_ProStock()%></td>
                    <td><%=ProdVO.getModificado_ProStock()%></td>
                    <td><%=ProdVO.getModificacion_fecha()%></td>
                    <td><%=ProdVO.getAccion() %></td>
                </tr>
                <%}%>
            </tbody>
        </table>
    ...
    <div class="fixed">
        ...
        <form method="POST" action="GeneradorReporte.jsp" target="_blank">
            ...
            <input type="hidden" name="reportName" value="modificacionespro">
        </form>
    </div>
</div>
