...
<div class="form-container">
    <div class="product-heading">
        <i class="fas fa-list"></i> Lista Venta
    </div>
    ...
    <form method="post" action="Producto">
        ...
        <table id="example" class="display nowrap" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Activo</td>
                    <td>
                        <button type="submit" name="opcion" value="consultarPorVenta" class="btn btn-outline-secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
                            <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z"/>
                            </svg>
                        </button>

                        <button type="submit" name="opcion" value="borrarventa"  class="btn botones-button" data-bs-toggle="modal" data-bs-target="#exampleModal">
        ...
        <div class="fixed">
            ...
            <button style="border-radius: 50%;" type="submit" name="opcion" value="consultarPorVentaActualizar" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#editar">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Si elimina la venta las subcompras relacionadas con esta se eliminaran
            </div>
            <div class="modal-footer">
                <button  class="btn btn-danger"  type="submit" name="opcion" value="borrarventa" >
                    Eliminar
                </button>
