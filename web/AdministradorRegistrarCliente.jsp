                    ...
                    <form class="row g-3" method="post" action="Cliente">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="cliNombre" class="form-control" size="11" minlength="3" maxlength="20" pattern="^[a-zA-Z\s]+$" required>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <input type="text" value="" class="form-control" name="cliTelefono" required  minlength="1" maxlength="12"  pattern="^[0-9]+$">
                                <label for="inputCity" class="form-label">Documento del cliente *</label>
                                <input type="text" value="" class="form-control" name="Documento" required  minlength="1" maxlength="12" pattern="^[0-9]+$">
                            ...
                            <div class="col-md-5">
                                ...
                                <button class="btn btn-secondary" type="submit" name="opcion" value="registrar" >Registrar</button>
                        ...
                        <table class="table" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input style="background: transparent;border: none;" type="text" value="<%=cliVO.getCliNombre()%>" size="1" name="cliNombre" minlength="1" maxlength="11"  ></input></td>
                                    <td><input  style="background: transparent;border: none;" type="text" value="<%=cliVO.getDocumento()%>" size="5" name="Documento" required  minlength="3" maxlength="12" readonly> </input></td>

                                    <td><input style="background: transparent;border: none;" type="text" value="<%=cliVO.getCliTelefono()%>" size="4" name="cliTelefono" minlength="1" maxlength="11" pattern="[0-9]+"></input></td>
                                    ...
                                    <td>
                                        <button class="btn btn-outline-secondary" type="submit" name="opcion" value="actualizar" >
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">El cliente se registro de forma exitosa</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            Si desea consultar Cliente elija la opcion de Consultar y si desea mantenerse en esta ventana elija cancelar
                                        </div>
                                        <div class="modal-footer">
                                            <a href="AdministradorListarCliente.jsp"><button type="button" class="btn btn-primary" data-bs-dismiss="modal">Consular</button></a>
                                            <a href="AdministradorRegistrarCliente.jsp"><button type="button" class="btn btn-success" data-bs-dismiss="modal">Cancelar</button></a>
