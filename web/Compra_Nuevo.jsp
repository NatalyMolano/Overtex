...
<div class="form-container">
    <div class="product-heading">
        <i class="fas fa-pencil-alt"></i> Registro Compra
    </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-10">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="Documento" class="form-control" value ="${proveedorEncontrado.getDocumento()}" size="11" minlength="3" maxlength="11" pattern="[0-9]+">
                                    ...
                                    <input type="hidden" name="MontoCompra" value ="0">
                                    <button class="btn botones-button" type="submit" name="opcion" value="consultarProveedor" onclick="mostrarOcultarMensaje()">
                                    ...
                                    <button type="submit" class="btn botones-button" type="submit" name="opcion" value="registrarCompra" >
                                ...
                                <p style="color: #666; font-size: smaller;">
                                    Presiona el botón de ☑ si es el proveedor
                                </p>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label>${proveedorEncontrado.getNombreEmpresa()}</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="input-group">
                                    ...
                                    <button type="submit" name="opcion" value="consultarcodigoCompra" class="btn botones-button">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        <input type="text" value="<%=ProdVO.getPrecioUnidad()%>" class="form-control" name="PrecioUnidad" size="11" minlength="3" maxlength="9" placeholder="0" readonly>
                                        <% CompraDAO comDAO = new CompraDAO();
                                            for (CompraVO comVO : comDAO.listarCod()) {%>
                                        <input name="IdCompra" type="hidden" value="<%=comVO.getId()%>">
                                    </div>
                                    <div class="col-md-5">
                                        <label class="form-label">Cantidad *</label>
                                        <input type="text" value="1" class="form-control" name="Cantidad" required size="11" minlength="1" maxlength="2" pattern="[0-9]+">
                                    </div>
                                </div>
                                <p><small>En existencia hay <%=ProdVO.getProStock()%></small></p>
                                <button class="btn btn-secondary" type="submit" name="opcion" value="registrarDetalleCompra">Agregar</button>
                ...
                <form  class="row g-3" method="post" action="Producto" >
                        ...
                        <table class="table" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input style="background: transparent; border: none;" type="hidden" value="<%=deVO.getId_DetalleCompra()%>" name="IdDetalleCompra" size="1" readonly></td>
                                    ...
                                    <td>
                                        <button type="submit" name="opcion" value="borrarDetalleCompra" class="btn botones-button">
                    ...
                    <div class="card-footer">
                        <div>
                            ...
                            <h6 align="right">Total compra <%=comVO.getMonto()%></h6>
                            <%}%>
                            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal">Finalizar Compra</button>
                            <%}%>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ¿Desea consultar la compra?
                                        </div>
                                        <div class="modal-footer">
                                            <a href="Compra_Nuevo.jsp"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Salir</button></a>
