...
<html>
    <head>
        ...
        <body>
            <div class="fixed">
                <button style="border-radius: 50%;" type="button"  class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <header class="site-header sticky-top py-1" style="background-color: #333;">
                <nav class="container d-flex flex-column flex-md-row justify-content-between" >
                    <h3 class="text-warning">OVERTEX</h3>
                    <a  class="py-2 d-none d-md-inline-block" href="Vista_Gerente.jsp" class="text-warning">Menu</a>
                    <a class="py-2 d-none d-md-inline-block" href="GerenteListarProveedor.jsp">Proveedor</a>
                    <a class="py-2 d-none d-md-inline-block" href="GerenteListarCompra.jsp">Compra</a>
