...
<div class="form-container">
    ...
    <div class="product-heading">
        <i class="fas fa-pencil-alt"></i> Listar Proveedor
    </div>
    <div class="d-flex">
        <div class="col-sm-10" >
            <div class="card">
                        ...
                        <table id="example" class="display nowrap" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%=proVO.getProvNombre()%> </input></td>
                                    <td><%=proVO.getProvApellido()%></input></td>
                                    <td><%=proVO.getNombreEmpresa()%></input></td>
                                    <td><%=proVO.getTelefono()%></input></td>
        ...
        <div class="card-body">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                <div class="text-center">
                    ...
                    <span class="text-body-secondary">Destacados</span>
                </div>
            </h4>
            <ul class="list-group mb-2">
                ...
                <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                        <h6 class="my-0"><%=cliente.getNombreEmpresa()%></h6>
                        <small class="text-body-secondary"><%=cliente.getDocumento()%></small>
                    </div>
                    <span class="text-body-secondary"><%=cliente.getConteo()%></span>
                </li>
                <%}%>
            </ul>
        </div>
    ...
    <div class="fixed">
        <a href="Proveedor_Registro.jsp">
            <button style="border-radius: 50%; " type="button"  class="btn btn-secondary" data-bs-dismiss="modal">
